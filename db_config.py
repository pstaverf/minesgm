...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:IYyTGByRhzZzfrAXcASigduVdidIbhsv@postgres.railway.internal:5432/railway")
REDIS_URL = os.getenv("REDIS_URL", "redis://default:aXDkONwaDWeimAyhNhOjTPcrSemHedzq@redis.railway.internal:6379")
